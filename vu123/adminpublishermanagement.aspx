<%@ Page Title="" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="adminpublishermanagement.aspx.cs" Inherits="vu123.adminpublishermanagement" %>
                        ...
                        <div class="row">
                            ...
                            <div class="col">
                                ...
                                <asp:GridView class="table table-striped table-bordered" ID="GridView1" runat="server" AutoGenerateColumns="False" DataSourceID="SqlDataSource2">
                                    <Columns>
                                        <asp:BoundField DataField="publisher_id" HeaderText="ID" SortExpression="publisher_id" />
